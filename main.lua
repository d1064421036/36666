...
local msgText = display.newText( "Hi, world!", world.x, world.y+190, native.systemFont, 32 )
msgText:setFillColor( 0.2, 0.6, 0.8 )

local msgText = display.newText( "Hi, world!", world.x, world.y+220, native.systemFont, 32 )
msgText:setFillColor( 0.2, 0.6, 0.8 )